...
class Grozs_Cena_Widget extends Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->add_control( 'section_content-text', [
            'label' => __('Teksts pirms cenas, kamēr nav veiktas izvēles', 'grozs'),
    ...
    protected function render() {
        ...
        ?>
        <div class="grozs-cena-widget">
            <div class="grozs-cena">
                <span id="price-value" data-min-price="<?php echo esc_attr($min_price); ?>">
                    <?php echo esc_html($settings['section_content-text'] ?? 'No' ); ?> 
