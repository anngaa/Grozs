...
// Frontenda stili
add_action('wp_enqueue_scripts', 'grozs_enqueue_frontend_styles', 1);
...
// Ielādējam epasta HTML veidnes
require_once GROZS_PATH . 'includes/email-templates.php';
...
// === Dashboard integrācijas (ADMIN only) ===
if ( is_admin() ) {
    // At a Glance + Activity pielāgojumi
    require_once GROZS_PATH . 'includes/admin/dashboard-glance-activity.php';

    // Pielāgotais "Pasūtījumi" logrīks
    require_once GROZS_PATH . 'includes/admin/dashboard-orders-widget.php';
}